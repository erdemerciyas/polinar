  ...
  categories: [
    {
      ...
      versions: {
        ...
        rows: [
          ...
          {
            label: 'Genişlik (iç/dış)',
            unit: 'mm',
            values: ['800', '1100'],
          },
          {
            label: 'Derinlik (iç/dış)',
            unit: 'mm',
            values: ['700', '800'],
          },
          {
            label: 'Yükseklik (iç/dış)',
            unit: 'mm',
            values: ['1500', '800'],
          },
        ],
    ...
    },
    {
      ...
      specs: [
        ...
        {
          label: 'Tork çıkışı',
          value: 'Şaft başına maks. 5 Nm',
        },
        {
          label: 'Kovan bölgeleri',
          value: '4 adet sıcaklık kontrollü bölge',
        },
        {
          label: 'Kalıplar',
          value: 'Şerit, cast film, bant, boru, ko-ekstrüzyon',
        },
        {
          label: 'Gereksinimler',
          value: '24A, 230V 1 faz, 50/60Hz',
        },
      ],
